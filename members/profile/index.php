...
if (isset($_POST) && !empty($_POST)) {
    if (isset($_POST['profile'])) {
        ...
        $phone = $_POST['phone'];
        $sql = "UPDATE tb_user SET firstname = '$firstname',lastname = '$lastname',phone = '$phone' where email = '$user'";
    ...
    if (isset($_POST['changepassword'])) {
        ...
        if (isset($oldpassword) && !empty($oldpassword)) {
            $sql_check = "SELECT * FROM tb_user WHERE email = '$user' AND password = '$oldpassword'";
            ...
            if ($row_check == 0) {
                ...
                if ($newpassword != $confirmnewpassword) {
                    ...
                    $sql = "UPDATE tb_user SET password = '$newpassword' where email = '$user'";
                    if (mysqli_query($connection, $sql)) {
...
<div class="row justify-content-between">
    <div class="col-auto">
        <h1 class="app-page-title mb-0">บัญชีผู้ใช้</h1>
    </div>
    <div class="col-auto">
    </div>
</div>
            ...
            <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                <div class="app-card-header p-3 border-bottom-0">
                    <div class="row align-items-center gx-3">
                        ...
                        <!--//col-->
                        <div class="col-auto">
                            <h4 class="app-card-title">โปรไฟล์ของฉัน</h4>
                        </div>
                        <!--//col-->
                    </div>
                    <!--//row-->
                    ...
                    <div class="item  py-3">
                        <div class="row  align-items-center">
                            <div class="">
                                ...
                                <div class="item-data"><input type="text" class="form-control" name="email" value="<?= $result['email'] ?>" disabled></div>
                            </div>
                            <!--//col-->
                        </div>
                        <!--//row-->
        ...
        <form action="" method="post">
            <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                    ...
                    <div class="item  py-3">
                        <div class="row  align-items-center">
                            <div class="">
                                ...
                                <div class="item-data"><input type="password" placeholder="รหัสผ่านเดิม" name="oldpassword" class="form-control"></div>
                            </div>
                            <!--//col-->
                        </div>
                        <!--//row-->
                    ...
                    <div class="item  py-3">
                        <div class="row  align-items-center">
                            <div class="">
                                ...
                                <div class="item-data"><input type="password" placeholder="รหัสผ่านใหม่" name="newpassword" class="form-control"></div>
                            </div>
                            <!--//col-->
                        </div>
                        <!--//row-->
                    ...
                    <div class="item  py-3">
                        <div class="row  align-items-center">
                            <div class="">
                                ...
                                <div class="item-data"><input type="password" placeholder="ยืนยันรหัสผ่านใหม่" name="confirmnewpassword" class="form-control"></div>
                            </div>
                            <!--//col-->
                        </div>
                        <!--//row-->
                ...
                <div class="app-card-footer p-4 mt-auto">
                    ...
                    <input type="submit" class="btn app-btn-secondary" value="เปลี่ยนรหัสผ่าน" />
                </div>
                <!--//app-card-footer-->
