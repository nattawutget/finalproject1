...
if (isset($_POST) && !empty($_POST)) {
	...
	if ($row > 0) {
		...
		$_SESSION['admin_login'] = $result['user'];
		$_SESSION['images_login'] = $result['image'];
			...
			<div class="d-flex flex-column align-content-end">
				...
				<footer class="app-auth-footer">
					<div class="container text-center py-3">
						...
						<small class="copyright">ระบบจองคิวสนามบอลSM FOOTBALL CLUB หลังบ้าน <i class="fas fa-heart" style="color: #fb866a;"></i> พัฒนาโดย <a class="app-link" href="http://themes.3rdwavemedia.com" target="_blank">SWE NBU</a> </small>
