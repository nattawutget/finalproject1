<?php
$sql = "SELECT *,a.id,a.title,ta.title AS title_type_accessory FROM tb_accessory a LEFT JOIN tb_type_accessory ta ON a.type_accessory_id = ta.id";
                    ...
                    <tbody class="text-center">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="align-middle"><?= $data['title_type_accessory'] ?></td>
