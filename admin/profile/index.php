...
if (isset($_POST) && !empty($_POST)) {
    if (isset($_POST['profile'])) {
        ...
        $sql = "UPDATE tb_admin SET firstname = '$firstname',lastname = '$lastname',email = '$email',phone = '$phone',image = '$filename' where user = '$user'";
            ...
            <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                ...
                <div class="app-card-body px-4 w-100">
                    <div class="item border-bottom py-3">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-auto">
                                ...
                                <div class="item-data"><img id="preview" class="profile-image  rounded-circle" src="upload/admin/<?= $_SESSION['images_login'] ?>" alt=""></div>
                            </div>
                            <!--//col-->
                            <div class="col text-end">
                                <!-- <a class="btn-sm app-btn-secondary" href="#">เปลี่ยน</a> -->
                    ...
                    <div class="item  py-3">
                        <div class="row  align-items-center">
                            <div class="">
                                <div class="item-label mb-2"><strong>นามสุกล</strong></div>
                    ...
                    <div class="item  py-3">
                        <div class="row  align-items-center">
                            <div class="">
                                ...
                                <div class="item-data"><input type="text" placeholder="รหัสผ่านเดิม" name="oldpassword" class="form-control"></div>
                            </div>
                            <!--//col-->
                        </div>
                        <!--//row-->
