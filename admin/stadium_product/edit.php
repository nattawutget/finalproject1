...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM tb_stadium where id = '$id' ";
...
if (isset($_POST) && !empty($_POST)) {
    ...
    // echo $filename;
    // exit();
    $sql = "UPDATE tb_stadium SET type_product_id = '$type_product_id',title = '$title',detail = '$detail',price = '$price',image = '$filename' where id = '$id'";
            ...
            <div class="app-card-body">
                <form action="" method="post" enctype=multipart/form-data>
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <img id="preview" src="upload/product/<?= $result['image'] ?>" class="rounded" width="150" height="150">
                        </div>
                    ...
                    <div class="mb-3 col-lg-6">
                        ...
                        <input type="text" class="form-control" name="title" placeholder="ชื่อสนาม" value="<?= $result['title'] ?>" autocomplete="off" required>
                    </div>
                    <div class="mb-3 col-lg-6">
