<?php
$sql = "SELECT *,p.id,p.title,tp.title AS title_type_product FROM tb_stadium p LEFT JOIN tb_type_product tp ON p.type_product_id = tp.id";
$query = mysqli_query($connection, $sql);
?>
<div class="row justify-content-between">
    <div class="col-auto">
        <h1 class="app-page-title mb-0">จัดการข้อมูลสนาม</h1>
    </div>
    <div class="col-auto">
    </div>
</div>
        ...
        <div class="app-card app-card-settings shadow-sm p-4">
            <div class="app-card-body">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a href="?page=<?= $_GET['page'] ?>&function=add" class="btn btn-primary text-white mb-4 float-right">เพิ่มสนาม</a>
                </div>
